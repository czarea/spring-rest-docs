package com.czarea.spring.restdocs;
...
import com.czarea.spring.restdocs.dao.UserRepository;
import com.czarea.spring.restdocs.entity.User;
import com.czarea.spring.restdocs.vo.UserInput;
...
public class SpringRestDocsApplicationTest {
    ...
    public void saveShouldReturnErrorIfLastNameIsEmpty() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .andExpect(jsonPath("$.[0].codes",
                containsInAnyOrder("NotNull", "NotNull.lastName", "NotNull.userInput.lastName", "NotNull.java.lang.String")))
    ...
    public void saveShouldReturnErrorIfLastNameIsTooLong() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .content(
                "{\"lastName\":\"should be less than sixty characters otherwise we get an error\",\"middleName\":\"Bar\",\"firstName\":\"Joe\",\"dateOfBirth\":\"2000-01-01\",\"siblings\":4}"))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.[0].message", is("Last name should be between 1 and 60 characters")))
            .andExpect(
                jsonPath("$.[0].codes", containsInAnyOrder("Size", "Size.lastName", "Size.userInput.lastName", "Size.java.lang.String")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
    ...
    public void saveShouldReturnErrorIfMiddleNameIsTooLong() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .content(
                "{\"lastName\":\"Doe\",\"middleName\":\"should be less than sixty characters otherwise we get an error\",\"firstName\":\"Joe\",\"dateOfBirth\":\"2000-01-01\",\"siblings\":4}"))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.[0].message", is("Middle name should be at most 60 characters")))
            .andExpect(jsonPath("$.[0].codes",
                containsInAnyOrder("Size", "Size.middleName", "Size.userInput.middleName", "Size.java.lang.String")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
    ...
    public void saveShouldReturnErrorIfFirstNameIsEmpty() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .andExpect(jsonPath("$.[0].codes",
                containsInAnyOrder("NotNull", "NotNull.firstName", "NotNull.userInput.firstName", "NotNull.java.lang.String")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
    ...
    public void saveShouldReturnErrorIfFirstNameIsTooLong() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .content(
                "{\"lastName\":\"Doe\",\"middleName\":\"Bar\",\"firstName\":\"should be less than sixty characters otherwise we get an error\",\"dateOfBirth\":\"2000-01-01\",\"siblings\":4}"))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.[0].message", is("First name should be between 1 and 60 characters")))
            .andExpect(
                jsonPath("$.[0].codes", containsInAnyOrder("Size", "Size.firstName", "Size.userInput.firstName", "Size.java.lang.String")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
    ...
    public void saveShouldReturnErrorIfDateOfBirthIsEmpty() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .andExpect(jsonPath("$.[0].codes",
                containsInAnyOrder("NotNull", "NotNull.dateOfBirth", "NotNull.userInput.dateOfBirth", "NotNull.java.time.LocalDate")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
    ...
    public void saveShouldReturnErrorIfDateOfBirthIsInFuture() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .andExpect(jsonPath("$.[0].codes",
                containsInAnyOrder("Past", "Past.dateOfBirth", "Past.userInput.dateOfBirth", "Past.java.time.LocalDate")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
    ...
    public void saveShouldReturnErrorIfSiblingsIsNull() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .content(
                "{\"lastName\":\"Doe\",\"middleName\":\"Bar\",\"firstName\":\"Joe\",\"dateOfBirth\":\"2000-01-01\",\"siblings\":null}"))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.[0].message", is("The amount of siblings should not be empty")))
            .andExpect(jsonPath("$.[0].codes",
                containsInAnyOrder("NotNull", "NotNull.siblings", "NotNull.userInput.siblings", "NotNull.java.lang.Integer")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
    ...
    public void saveShouldReturnErrorIfSiblingsIsNegative() throws Exception {
        mockMvc.perform(post("/api/user")
            ...
            .andExpect(jsonPath("$.[0].codes",
                containsInAnyOrder("PositiveOrZero", "PositiveOrZero.siblings", "PositiveOrZero.userInput.siblings",
                    "PositiveOrZero.java.lang.Integer")))
            .andDo(document("{method-name}", userInput(), apiError()));
    }
